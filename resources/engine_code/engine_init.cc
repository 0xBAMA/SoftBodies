...
void engine::displaySetup() {
  ...
  // texture parameters
  bool filterDisplayTexture = true;
  glTexParameterf( GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, filterDisplayTexture ? GL_LINEAR : GL_NEAREST );
  glTexParameterf( GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, filterDisplayTexture ? GL_LINEAR : GL_NEAREST );
